    ...
    <>
        ...
        <div className='flex space-x-4 mt-4 bg-pattern bg-cover rounded-lg'>
          <div className='hero-left flex flex-col md:w-1/2'>
            ...
            <div className='flex'>
            <button class="flex align-middle justify-center p-5 mt-8 items-center w-100 px-6 py-3 border-2 border-slate-900 rounded-lg font-bold tracking-wide uppercase text-slate-900 hover:bg-slate-50 transition-colors">
          ...
          <div className='testimonial mt-12 flex'>
            ...
            <div className='star-section flex-col ml-6'>
              <div className="star-image flex">
                {[...Array(5)].map((_, i) => (
                  <img key={i} src={assets.star} className = "size-7 ml-0" alt="star" />
                ))}
              </div>

              <div className="text">
                <p className="text-xs"><span>200+</span> developers joined already</p>
              </div>
            </div>
          </div>
        </div>
